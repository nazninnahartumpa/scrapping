...
def configure_driver():
    ...
    driver = webdriver.Chrome(executable_path=r"E:\\martspy_project\\scrapping_related\\test_scrapy\\scrappy_test_prj\\chromedriver.exe", options = chrome_options)
    return driver
...
class NikeSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for single_url in url_list:
            ...
            # scrape title
            brand_name = self.driver.find_element_by_xpath('//h1/span[2]').text
